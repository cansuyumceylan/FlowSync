...
export default function Timer() {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-6">
            ...
            {activeTask && (
                <div className="mb-6 px-4 py-2 bg-white/5 border border-white/10 rounded-full flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-mint animate-pulse" />
                    <span className="text-sm font-medium text-white/80">Working on: <span className="text-white">{activeTask.title}</span></span>
                </div>
            )}
